...
- UC-6: просмотр отчетов о деятельности по ученику за какой-либо промежуток времени
- UC-7: формирование домашних заданий
- UC-8: оценивание домашних заданий
- UC-9: просмотр домашних заданий
- UC-10: просмотр сведений о присутствии учащихся на занятиях
- UC-11: создание раздела, темы, поста на форуме
