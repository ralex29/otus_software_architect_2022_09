...
Таким образом выделяется 3 агрегата: Трекер заявок - отслеживает контекст всех обрабатываемых заявок в 
системе и всех Исполнителей заявок, Исполнитель заявок - отслеживает контекст выполнения тестов выполняемых в рамках 
...
Также имеется Генератор нагрузки - генерирующий и анализирующий нагрузочный профиль в рамках теста.   
